...
namespace soci {
template <>
struct type_conversion<seller> {
    using base_type = values;

    static void from_base(values const &v, indicator ind, seller &l) {
        /*
    ...
    static void to_base(seller const &l, values &v, indicator &ind) {
        /*
